Funbit.Ets.Telemetry.Dashboard.prototype.initialize = function (skinConfig, utils) {
    ...
    utils.preloadImages([
		...
		'images/beacon-off.png', 'images/beacon-on.png',
...
Funbit.Ets.Telemetry.Dashboard.prototype.filter = function (data, utils) {
	...
	data.game.restIn = this.timeDifferenceToReadableString(data.game.nextRestStopTime);
	data.navigation.arriveIn = this.timeDifferenceToReadableString(data.navigation.estimatedTime);
